      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-8">
            {['Problems', 'Contests', 'Discuss', 'Learn', 'Pricing'].map((item, index) => (
              <motion.a
                key={item}
                href="#"
                className={`font-medium hover:text-primary-500 transition-colors ${isScrolled ? 'text-gray-700' : 'text-white'
                  }`}
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <motion.button
              className={`px-4 py-2 rounded-lg font-medium ${isScrolled
